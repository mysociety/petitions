...
//
// $Id: about.php,v 1.1 2006-07-13 14:15:44 matthew Exp $
...
<p>Downing Street is working in partnership with the non-partisan charitable project mySociety to provide a service to allow citizens, charities and campaign groups to set up petitions that are hosted on the Downing Street website. This service enables anyone to address a petition directly to the Prime Minister.</p>
...
<p>The e-petition system is run the principle that people should have complete confidence that it is fair and transparent. There are basic conditions that this service must meet - for example we cannot host offensive, libelous or party political petitions. Our <a href="">acceptance policy</a>(?) explains in full the conditions that must be met. But the main aim is to make it possible for the widest number of people to make their views heard.</p>
