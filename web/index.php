...
if (OPTION_SITE_NAME == 'sbdc' || OPTION_SITE_NAME == 'sbdc1' || strpos(OPTION_SITE_NAME, 'surrey')!==false || OPTION_SITE_NAME=='lichfielddc' || OPTION_SITE_NAME=='waveney' || OPTION_SITE_NAME == 'barrowbc') {
