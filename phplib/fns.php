...
//
// $Id: fns.php,v 1.10 2006-11-17 16:55:11 matthew Exp $
...
<input type="text" name="q" id="q" maxlength="1000" value="<?=htmlspecialchars(get_http_var('q'))?>" />&nbsp;<input type="submit" value="Go" />
</form>
<?
}
